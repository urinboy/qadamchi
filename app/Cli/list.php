...
$commands = [
    ...
    'cache:clear'          => 'Ilova keshini tozalash (framework/cache)',
    'view:clear'           => 'Compiled Blade view fayllarini tozalash (framework/views)',
    'config:clear'         => 'Config keshini tozalash',
    'route:clear'          => 'Route keshini tozalash',
    'optimize:clear'       => 'Barcha keshlarni tozalash (view+cache+config+route+session)',
