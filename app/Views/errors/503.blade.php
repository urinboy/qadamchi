...
<head>
    ...
    <style>
        ...
        .code { font-size: clamp(56px, 14vw, 80px); font-weight: 800; letter-spacing: -.04em; color: var(--warn); line-height: 1; margin-bottom: 12px; }
...
<body>
    <div class="error-card">
        ...
        <p class="msg">Xizmat vaqtinchalik mavjud emas (texnik xizmat).</p>
