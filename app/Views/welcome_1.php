...
<body>
    <div class="container">
        <img src="/assets/logo.svg" class="logo" alt="Qadamchi Logo" />
        <h2>Xush kelibsiz!</h2>
        <div class="subtitle">O‘zbekistonlik dasturchilar uchun <br>zamonaviy PHP mikro freymvorki.<br>
        <span style="color:#228be6;">Ochiq manba. Tez. Oddiy.</span>
        <h1 style="text-align: center;"><?= env('APP_NAME', 'Qadamchi');?></h1>
        </div>
        <div class="links">
